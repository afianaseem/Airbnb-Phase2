...
function Details({listing}) {
  ...
  return (
    <>
    <div id="container">
       <div id="left"><h4> <span>{listing.room_type} </span> <span> , {listing.address.country}</span></h4>
        <div id="b"><span>bedrooms {listing.bedrooms}</span> <span> . bathrooms {listing.bathrooms}</span></div>
        ...
        <div id="price_box">
         <div id="price">{listing.price} $ <span id="night">night</span> </div>
         <hr/>
